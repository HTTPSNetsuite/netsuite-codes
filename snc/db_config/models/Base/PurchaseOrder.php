...
abstract class PurchaseOrder implements ActiveRecordInterface
{
    ...
    /**
     * The value for the is_sync field.
    ...
    public function setFilename($v)
    {
        ...
        if ($this->filename !== $v) {
            $this->filename = $v;
            $this->modifiedColumns[PurchaseOrderTableMap::COL_FILENAME] = true;
        }
    ...
    public function setStore($v)
    {
        ...
        if ($this->store !== $v) {
            $this->store = $v;
            $this->modifiedColumns[PurchaseOrderTableMap::COL_STORE] = true;
        }
    ...
    /**
     * Set the value of [is_sync] column.
     *
     * @param string $v new value
     * @return $this|\PurchaseOrder The current object (for fluent API support)
     */
    public function setIsSync($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->is_sync !== $v) {
            $this->is_sync = $v;
            $this->modifiedColumns[PurchaseOrderTableMap::COL_IS_SYNC] = true;
        }
    ...
    public function setCustomerCode($v)
    {
        ...
        if ($this->customer_code !== $v) {
            ...
            $this->modifiedColumns[PurchaseOrderTableMap::COL_CUSTOMER_CODE] = true;
        }
    ...
    public function setDateCreated($v)
    {
        ...
        if ($this->date_created !== null || $dt !== null) {
            if ($this->date_created === null || $dt === null || $dt->format("Y-m-d") !== $this->date_created->format("Y-m-d")) {
                $this->date_created = $dt === null ? null : clone $dt;
                $this->modifiedColumns[PurchaseOrderTableMap::COL_DATE_CREATED] = true;
            }
    ...
    public function setDeliveryDate($v)
    {
        ...
        if ($this->delivery_date !== null || $dt !== null) {
            if ($this->delivery_date === null || $dt === null || $dt->format("Y-m-d") !== $this->delivery_date->format("Y-m-d")) {
                ...
                $this->modifiedColumns[PurchaseOrderTableMap::COL_DELIVERY_DATE] = true;
            }
        } // if either are not null
    ...
    public function setNumber($v)
    {
        ...
        if ($this->number !== $v) {
            $this->number = $v;
            $this->modifiedColumns[PurchaseOrderTableMap::COL_NUMBER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PurchaseOrderTableMap::translateFieldName('Filename', TableMap::TYPE_PHPNAME, $indexType)];
            $this->filename = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PurchaseOrderTableMap::translateFieldName('Store', TableMap::TYPE_PHPNAME, $indexType)];
            $this->store = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PurchaseOrderTableMap::translateFieldName('IsSync', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_sync = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : PurchaseOrderTableMap::translateFieldName('CustomerCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->customer_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : PurchaseOrderTableMap::translateFieldName('DateCreated', TableMap::TYPE_PHPNAME, $indexType)];
            $this->date_created = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : PurchaseOrderTableMap::translateFieldName('DeliveryDate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->delivery_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : PurchaseOrderTableMap::translateFieldName('Number', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 8; // 8 = PurchaseOrderTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PurchaseOrderTableMap::COL_FILENAME)) {
            $modifiedColumns[':p' . $index++]  = 'filename';
        }
        if ($this->isColumnModified(PurchaseOrderTableMap::COL_STORE)) {
            $modifiedColumns[':p' . $index++]  = 'store';
        }
        if ($this->isColumnModified(PurchaseOrderTableMap::COL_IS_SYNC)) {
            $modifiedColumns[':p' . $index++]  = 'is_sync';
        }
        if ($this->isColumnModified(PurchaseOrderTableMap::COL_CUSTOMER_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'customer_code';
        }
        if ($this->isColumnModified(PurchaseOrderTableMap::COL_DATE_CREATED)) {
            $modifiedColumns[':p' . $index++]  = 'date_created';
        }
        if ($this->isColumnModified(PurchaseOrderTableMap::COL_DELIVERY_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'delivery_date';
        }
        if ($this->isColumnModified(PurchaseOrderTableMap::COL_NUMBER)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'store':
                        ...
                        break;
                    case 'is_sync':
                        $stmt->bindValue($identifier, $this->is_sync, PDO::PARAM_STR);
                        break;
                    case 'customer_code':
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) {
            $this->setIsSync($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setCustomerCode($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setDateCreated($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setDeliveryDate($arr[$keys[6]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PurchaseOrderTableMap::COL_FILENAME)) {
            $criteria->add(PurchaseOrderTableMap::COL_FILENAME, $this->filename);
        }
        if ($this->isColumnModified(PurchaseOrderTableMap::COL_STORE)) {
            $criteria->add(PurchaseOrderTableMap::COL_STORE, $this->store);
        }
        if ($this->isColumnModified(PurchaseOrderTableMap::COL_IS_SYNC)) {
            $criteria->add(PurchaseOrderTableMap::COL_IS_SYNC, $this->is_sync);
        }
        if ($this->isColumnModified(PurchaseOrderTableMap::COL_CUSTOMER_CODE)) {
            $criteria->add(PurchaseOrderTableMap::COL_CUSTOMER_CODE, $this->customer_code);
        }
        if ($this->isColumnModified(PurchaseOrderTableMap::COL_DATE_CREATED)) {
            $criteria->add(PurchaseOrderTableMap::COL_DATE_CREATED, $this->date_created);
        }
        if ($this->isColumnModified(PurchaseOrderTableMap::COL_DELIVERY_DATE)) {
            $criteria->add(PurchaseOrderTableMap::COL_DELIVERY_DATE, $this->delivery_date);
        }
        if ($this->isColumnModified(PurchaseOrderTableMap::COL_NUMBER)) {
            $criteria->add(PurchaseOrderTableMap::COL_NUMBER, $this->number);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setIsSync($this->getIsSync());
