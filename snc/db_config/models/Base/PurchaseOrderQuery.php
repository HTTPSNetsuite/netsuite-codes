 ...
 * @method     ChildPurchaseOrderQuery orderByDateCreated($order = Criteria::ASC) Order by the date_created column
 ...
 * @method     ChildPurchaseOrderQuery groupByDateCreated() Group by the date_created column
 ...
 * @method     ChildPurchaseOrder findOneByDateCreated(string $date_created) Return the first ChildPurchaseOrder filtered by the date_created column
 ...
 * @method     ChildPurchaseOrder requireOneByDateCreated(string $date_created) Return the first ChildPurchaseOrder filtered by the date_created column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildPurchaseOrder[]|ObjectCollection findByDateCreated(string $date_created) Return ChildPurchaseOrder objects filtered by the date_created column
...
abstract class PurchaseOrderQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, filename, store, is_sync, customer_code, date_created, delivery_date, number FROM purchase_order WHERE id = :p0';
        try {
    ...
    public function filterByDateCreated($dateCreated = null, $comparison = null)
    {
        if (is_array($dateCreated)) {
            ...
            if (isset($dateCreated['min'])) {
                $this->addUsingAlias(PurchaseOrderTableMap::COL_DATE_CREATED, $dateCreated['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($dateCreated['max'])) {
                $this->addUsingAlias(PurchaseOrderTableMap::COL_DATE_CREATED, $dateCreated['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PurchaseOrderTableMap::COL_DATE_CREATED, $dateCreated, $comparison);
    }
