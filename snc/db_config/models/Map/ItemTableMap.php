...
class ItemTableMap extends TableMap
{
     ...
     */
    const COL_PURCHASE_ORDER_ID = 'item.purchase_order_id';

    /**
     * the column name for the upc field
     */
    const COL_UPC = 'item.upc';

    /**
     * the column name for the qty field
     */
    const COL_QTY = 'item.qty';

    /**
     * the column name for the discount field
     */
    const COL_DISCOUNT = 'item.discount';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'PurchaseOrderId', 'Upc', 'Qty', 'Discount', ),
        self::TYPE_CAMELNAME     => array('id', 'purchaseOrderId', 'upc', 'qty', 'discount', ),
        self::TYPE_COLNAME       => array(ItemTableMap::COL_ID, ItemTableMap::COL_PURCHASE_ORDER_ID, ItemTableMap::COL_UPC, ItemTableMap::COL_QTY, ItemTableMap::COL_DISCOUNT, ),
        self::TYPE_FIELDNAME     => array('id', 'purchase_order_id', 'upc', 'qty', 'discount', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'PurchaseOrderId' => 1, 'Upc' => 2, 'Qty' => 3, 'Discount' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'purchaseOrderId' => 1, 'upc' => 2, 'qty' => 3, 'discount' => 4, ),
        self::TYPE_COLNAME       => array(ItemTableMap::COL_ID => 0, ItemTableMap::COL_PURCHASE_ORDER_ID => 1, ItemTableMap::COL_UPC => 2, ItemTableMap::COL_QTY => 3, ItemTableMap::COL_DISCOUNT => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'purchase_order_id' => 1, 'upc' => 2, 'qty' => 3, 'discount' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ItemTableMap::COL_PURCHASE_ORDER_ID);
            $criteria->addSelectColumn(ItemTableMap::COL_UPC);
            $criteria->addSelectColumn(ItemTableMap::COL_QTY);
            $criteria->addSelectColumn(ItemTableMap::COL_DISCOUNT);
        } else {
