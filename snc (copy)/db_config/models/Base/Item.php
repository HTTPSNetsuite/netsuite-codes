...
abstract class Item implements ActiveRecordInterface
{
    ...
    public function setPurchaseOrderId($v)
    {
        ...
        if ($this->purchase_order_id !== $v) {
            ...
            $this->modifiedColumns[ItemTableMap::COL_PURCHASE_ORDER_ID] = true;
        }
    ...
    public function setUpc($v)
    {
        ...
        if ($this->upc !== $v) {
            $this->upc = $v;
            $this->modifiedColumns[ItemTableMap::COL_UPC] = true;
        }
    ...
    public function setQty($v)
    {
        ...
        if ($this->qty !== $v) {
            $this->qty = $v;
            $this->modifiedColumns[ItemTableMap::COL_QTY] = true;
        }
    ...
    public function setDiscount($v)
    {
        ...
        if ($this->discount !== $v) {
            $this->discount = $v;
            $this->modifiedColumns[ItemTableMap::COL_DISCOUNT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ItemTableMap::translateFieldName('PurchaseOrderId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->purchase_order_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ItemTableMap::translateFieldName('Upc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->upc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ItemTableMap::translateFieldName('Qty', TableMap::TYPE_PHPNAME, $indexType)];
            $this->qty = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ItemTableMap::translateFieldName('Discount', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ItemTableMap::COL_PURCHASE_ORDER_ID)) {
            $criteria->add(ItemTableMap::COL_PURCHASE_ORDER_ID, $this->purchase_order_id);
        }
        if ($this->isColumnModified(ItemTableMap::COL_UPC)) {
            $criteria->add(ItemTableMap::COL_UPC, $this->upc);
        }
        if ($this->isColumnModified(ItemTableMap::COL_QTY)) {
            $criteria->add(ItemTableMap::COL_QTY, $this->qty);
        }
        if ($this->isColumnModified(ItemTableMap::COL_DISCOUNT)) {
            $criteria->add(ItemTableMap::COL_DISCOUNT, $this->discount);
        }
