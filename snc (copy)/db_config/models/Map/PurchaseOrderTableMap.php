...
class PurchaseOrderTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Filename', 'Store', 'IsSync', 'CustomerCode', 'DeliveryDate', 'Number', ),
        self::TYPE_CAMELNAME     => array('id', 'filename', 'store', 'isSync', 'customerCode', 'deliveryDate', 'number', ),
        self::TYPE_COLNAME       => array(PurchaseOrderTableMap::COL_ID, PurchaseOrderTableMap::COL_FILENAME, PurchaseOrderTableMap::COL_STORE, PurchaseOrderTableMap::COL_IS_SYNC, PurchaseOrderTableMap::COL_CUSTOMER_CODE, PurchaseOrderTableMap::COL_DELIVERY_DATE, PurchaseOrderTableMap::COL_NUMBER, ),
        self::TYPE_FIELDNAME     => array('id', 'filename', 'store', 'is_sync', 'customer_code', 'delivery_date', 'number', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Filename' => 1, 'Store' => 2, 'IsSync' => 3, 'CustomerCode' => 4, 'DeliveryDate' => 5, 'Number' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'filename' => 1, 'store' => 2, 'isSync' => 3, 'customerCode' => 4, 'deliveryDate' => 5, 'number' => 6, ),
        self::TYPE_COLNAME       => array(PurchaseOrderTableMap::COL_ID => 0, PurchaseOrderTableMap::COL_FILENAME => 1, PurchaseOrderTableMap::COL_STORE => 2, PurchaseOrderTableMap::COL_IS_SYNC => 3, PurchaseOrderTableMap::COL_CUSTOMER_CODE => 4, PurchaseOrderTableMap::COL_DELIVERY_DATE => 5, PurchaseOrderTableMap::COL_NUMBER => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'filename' => 1, 'store' => 2, 'is_sync' => 3, 'customer_code' => 4, 'delivery_date' => 5, 'number' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
